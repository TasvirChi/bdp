This plugin makes sounds in response to BDP notifications it receives.
It is a demoplugin focusing on showing how to build a non visual BDP plugin.
The project holds a BDP swf in a debug mode under html-template folder, meaning you should be 
able to test your plugin without having to compile the BDP project.
