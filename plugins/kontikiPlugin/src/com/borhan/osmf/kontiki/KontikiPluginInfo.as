package com.borhan.osmf.kontiki
{
	...
	public class KontikiPluginInfo extends PluginInfo
	{
		...
		{
			var mediaInfo : MediaFactoryItem = new MediaFactoryItem("com.borhan.osmf.kontiki.KontikiElement", canHandleResource, createKontikiMediaElement );
