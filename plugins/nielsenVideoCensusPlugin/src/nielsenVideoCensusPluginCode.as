package
{
	...
	import com.borhan.bdpfl.plugin.component.NielsenVideoCensusMediator;
	...
	public dynamic class nielsenVideoCensusPluginCode extends Sprite implements IPlugin
	{
		...
		public function onBeacon(e:Event=null):void{
			...
			// NOTE: total length can only be determined.  unable to determine length of segments with current BDP3 libraries
			if(lp)
		...
		//3. LF & SF Length in seconds of this segment/chapter. Set to 0 if not known. currently no way to get this information from bdp libs
