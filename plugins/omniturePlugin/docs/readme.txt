...
MEDIA_READY_EVENT
SEEK_EVENT
REPLAY_EVENT (only if it gets this notification – this is not part of the BDP normal behavior) 
...
advantages: 
very dynamicly. 
Can get access to every exposed data from the BDP, including custom flashvars (this is very
