package  {
	...
	import tv.freewheel.playerextension.bdpanalytics.AdInfo;
	import tv.freewheel.playerextension.bdpanalytics.CustomEvent;
	...
	public class freeWheelAnalyticsExtension extends Sprite implements IEventDispatcher{
		...
		public static const PARAM_NAMESPACE:String = "extension.bdpanalytics";
		...
		public function freeWheelAnalyticsExtension(){			
			...
			//trace("new BDPAnalyticsExtension() - Version: " + VERSION + " RDK Version: " + RDK_VERSION);
		}
		...
		public function init(am:Object):void {
			...
			this.logger = Logger.getLogger(am, this.constants, "BDPAnalyticsExtension ");
