...
package com.borhan.base.types
{
	...
	/**
	 * MediaTypes defines all media types avilable for the borhan server.
	 */
	public class MediaTypes
	{
		static public var localeBundleName:String = "borhancvf";
		 ...
		 * @return 				uint type.
		 * @see com.borhan.common.types.MediaTypes#translateIntTypeToString
		 */
		 ...
		 * @see com.borhan.common.types.MediaTypes#translateStringTypeToInt
		 */
