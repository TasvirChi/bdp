This project is a demo showing how to build a visual BDP plugin.
This project holds a BDP swf in a debug mode under html-template folder, meaning you should be able to
 test your plugin without having to compile the BDP project.
