...
package com.borhan.base.vo
{
	...
	//[Bindable]
	public class BorhanPluginInfo extends EventDispatcher
	{
		/**
		...
		*/
		public var creator:String = 'Borhan';
		/**
		...
		*/
		 ...
		 */
		public function BorhanPluginInfo (media_type:uint,
											plugin_id:String,
											thumbnail_url:String,
											plugin_category:String,
											plugin_label:String,
											plugin_creator:String = 'Borhan',
