...
{
	import com.borhan.net.streaming.events.NetClientEvent;
	 ...
	 *  @eventType com.borhan.net.streaming.events.NetClientEvent.ON_METADATA_BUFFER_SIZES
	 */
	[Event(name="onMetadataBufferSizes", type="com.borhan.net.streaming.events.NetClientEvent")]

	/**
	 *  Dispatched when the Netstream client gets to the end of the stream.
	 *  @eventType com.borhan.net.streaming.events.NetClientEvent.ON_STREAM_END
	 */
	[Event(name="onStreamEnd", type="com.borhan.net.streaming.events.NetClientEvent")]

	/**
	 *  Dispatched when the Netstream client gets event that the stream has been switched on the server sequence (playlist mode).
	 *  @eventType com.borhan.net.streaming.events.NetClientEvent.ON_STREAM_SWITCH
	 */
	[Event(name="onStreamSwitch", type="com.borhan.net.streaming.events.NetClientEvent")]

	/**
	 *  Dispatched when the Netstream client gets to the last second before the stream ends.
	 *  @eventType com.borhan.net.streaming.events.NetClientEvent.ON_LAST_SECOND
	 */
	[Event(name="onLastSecond", type="com.borhan.net.streaming.events.NetClientEvent")]
	 ...
	 * @see com.borhan.net.streaming.StreamMetaData
	 */
