...
package com.borhan.managers.downloadManagers.protocols
{
	...
	import com.borhan.managers.downloadManagers.pluginManager.PluginLoadingModes;
	import com.borhan.managers.downloadManagers.pluginManager.PluginMultiton;
	...
	{
		static public var model:BorhanModelLocator = BorhanModelLocator.getInstance();
		...
		public function load(source_asset:AbstractAsset):IMediaSourceLoader
		{
			...
			var debugFromIDE:Boolean = BorhanApplication.getInstance().applicationConfig.debugFromIDE;
