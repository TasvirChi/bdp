...
@ignore
*/
package com.borhan.managers.downloadManagers.imagesManager
{
	import com.borhan.dataStructures.HashMap;
	import com.borhan.dataStructures.IMap;
	import com.borhan.net.loaders.MediaSourceLoader;
	import com.borhan.net.loaders.interfaces.IMediaSourceLoader;
	import com.borhan.net.nonStreaming.LoaderDisplayObject;
	...
	public class ImagesManager extends EventDispatcher
	{
		...
		*/
		 ...
		 * @see			com.borhan.net.nonStreaming.LoaderDisplayObject
		 */
