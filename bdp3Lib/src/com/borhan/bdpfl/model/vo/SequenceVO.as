package com.borhan.bdpfl.model.vo
{
	...
	[Bindable]
	/**
	 * Class SequenceVO holds parameters related to the BDP sequence mechanism. 
	 * @author Hila
	 * 
	 */	
	public class SequenceVO
	{
		 ...
		 * b. The only way that this midroll is of interest to us is if it's playing in the BDP MediaPlayer.
		 */		
