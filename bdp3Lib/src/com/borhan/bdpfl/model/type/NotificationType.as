...
{
	/**
	 * Class NotificationType holds the constants representing the notifications fired within the BDP. 
	 * @author Hila
	 * 
	 */	
	public class NotificationType
	{
		...
		/**
		 * The BaseEntry object has been retrieved but BDP can't play the entry
		...
		*/ 
		 ...
		 * DEPRECATED
		  ...
		  * entry/media in the BDP, and that it is ready to load alternate media/entries.
		  */		 
		 ...
		 /**
		  * Notification fired when preloader was loaded externally from preloader path, and was loaded after the bdp.swf was loaded
